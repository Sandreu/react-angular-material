...
var DialogDemo = React.createClass({displayName: "DialogDemo",
    ...
    render: function () {
        return (
            React.createElement("div", null, 
                React.createElement(Md.Button, {decorator: "raised", onClick: this.showSimpleDialog}, "Simple Dialog")
            )
        );
    }
});
